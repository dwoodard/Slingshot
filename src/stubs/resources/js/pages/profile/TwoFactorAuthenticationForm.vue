<template>
  <v-layout row wrap>
    <v-flex xs12 sm6>
      ...
      <h6>Add additional security to your account using two factor authentication.</h6>
    </v-flex>
    <v-flex xs12 sm6>
      <v-card class="pa-3">
        ...
        <div class="mt-5">
          <div v-if="! twoFactorEnabled">
            <jet-confirms-password @confirmed="enableTwoFactorAuthentication">
              <v-btn type="button" :class="{ 'opacity-25': enabling }" :disabled="enabling">
                Enable
              </v-btn>
          ...
          <div v-else>
            <jet-confirms-password @confirmed="regenerateRecoveryCodes">
              <v-btn v-if="recoveryCodes.length > 0"
                     class="mr-3">
            ...
            <jet-confirms-password @confirmed="showRecoveryCodes">
              <v-btn v-if="recoveryCodes.length === 0" class="mr-3">
                Show Recovery Codes
              </v-btn>
            </jet-confirms-password>
...
<script>
  ...
  import JetConfirmsPassword from '@/vendor/Jetstream/ConfirmsPassword';
